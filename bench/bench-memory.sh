...
#       --csv PATH           CSV results file (default: <repo>/benchmarks/bench-results.csv)
#       --log PATH           Human-readable log (default: <repo>/benchmarks/bench-memory.log)
...
KEEP_ALIVE="5m"
NUM_CTX=""
BENCH_DIR="$(cd "$(dirname "${BASH_SOURCE[0]:-$0}")/.." 2>/dev/null && pwd)/benchmarks"
